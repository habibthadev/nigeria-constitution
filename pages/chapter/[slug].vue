...
const pageTitle = computed(() =>
  title.value
    ? `${chapterLabel.value} — ${title.value} | Nigeria Constitution`
    : `${chapterLabel.value} | Nigeria Constitution`
)

useHead({
  title: pageTitle,
  meta: [
    { name: 'description', content: computed(() => `${title.value || chapterLabel.value} — The 1999 Constitution of the Federal Republic of Nigeria.`) },
    { property: 'og:title', content: pageTitle },
    { property: 'og:description', content: computed(() => `${title.value || chapterLabel.value} — The 1999 Constitution of the Federal Republic of Nigeria.`) },
...
defineOgImageComponent('Constitution', {
  label: chapterLabel.value,
  title: title.value || chapterLabel.value,
